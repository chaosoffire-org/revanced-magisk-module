...
--keystore-entry-password=${KEYSTORE_PASSWORD:-123456789} --keystore-password=${KEYSTORE_PASSWORD:-123456789} --signer=${KEYSTORE_ALIAS:-jhc} --keystore-entry-alias=${KEYSTORE_ALIAS:-jhc} $patcher_args"
